;メッセージレイヤの定義
		...
		[position width=1240 height=237 top=417 left=20 ]
			...
			[position page=fore margint=45 marginl=20 marginr=20 marginb=10 vertical=false opacity="180" radius="0" color="0x000000" ]
		...
		[eval exp="sf._tb_replay_noimage='本2.png'" ]
